...
const CTA = () => (
  <div className="flex items-center justify-center p-5 bg-gray-100 min-w-screen">
    <div
        className="relative flex flex-col items-center w-full max-w-6xl px-4 py-8 mx-auto text-center rounded-lg shadow-2xl lg:text-left lg:block bg-gradient-to-br from-blue-600 via-indigo-500 to-teal-400 sm:px-6 md:pb-0 md:pt-12 lg:px-12 lg:py-12">
        <h2
            ...
            Vamos juntos <span className="block text-indigo-200 xl:inline">Evitar o corte</span>
        </h2>
        <p className="mt-1 mb-10 text-sm font-medium text-indigo-200 uppercase xl:text-base xl:tracking-wider lg:mb-0">
            Veja como pagar suas contas Online!</p>
