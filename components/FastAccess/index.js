...
const FastAccess = () => (
    ...
    <section>
        <h2 class="text-4xl font-extrabold text-center text-gray-700">Acesso Rápido</h2>
        <p class="text-center text-gray-600 text-md">Follow these steps to complete the challenge.</p>
                ...
                <div class="relative w-64 h-48">
                    <div
                        ...
                        <div class="w-2/3 h-32 pr-4">
                            <h3 class="pt-1 text-xl font-semibold text-gray-700">Segunda Via</h3>
                            <p class="pt-1 text-sm text-gray-600">Analyse the problem sets to find a better solution to the issue.</p>
                        </div>
                    </div>
            ...
            <div class="flex justify-center pt-10 m-auto lg:w-1/4 lg:mx-6 lg:my-8">
                <div class="relative w-64 h-48">
                    <div
                        ...
                        <div class="w-1/3 h-40"></div>
                        <div class="w-2/3 h-32 pr-4">
                            <h3 class="pt-1 text-xl font-semibold text-gray-700">Faltou Energia?</h3>
                            <p class="pt-1 text-sm text-gray-600">Design is how the solution will be interacted with.</p>
                        </div>
                    </div>
                    <div class="absolute top-0 left-0 z-20 w-12 h-12 mt-6 ml-6 bg-white rounded-full">
            ...
            <div class="flex justify-center pt-10 m-auto lg:w-1/4 lg:mx-6 lg:my-8">
                <div class="relative w-64 h-48">
                    <div
                        ...
                        <div class="w-1/3 h-40"></div>
                        <div class="w-2/3 h-32 pr-4">
                            <h3 class="pt-1 text-xl font-semibold text-gray-700">Atualizar Cadastro</h3>
                            <p class="pt-1 text-sm text-gray-600">Altere seus dados facilmente.</p>
                        </div>
                    </div>
                    <div class="absolute top-0 left-0 z-20 w-12 h-12 mt-6 ml-6 bg-white rounded-full">
