        ...
        <section id="bottom-navigation" class="md:hidden block fixed inset-x-0 bottom-0 z-10 bg-white shadow">
            <section id="bottom-navigation" class="block fixed inset-x-0 bottom-0 z-10 bg-white shadow">
                <div id="tabs" class="flex justify-between">
                    <a href="#" class="w-full focus:text-blue-600 hover:text-blue-600 justify-center inline-block text-center pt-2 pb-1">
                        ...
                        <span class="tab tab-home block text-xs">Início</span>
                    </a>
                    <a href="#" class="w-full focus:text-blue-600 hover:text-blue-600 justify-center inline-block text-center pt-2 pb-1">
                        <svg width="25" height="25" viewBox="0 0 24 24" class="inline-block mb-1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <path d="M19 11H5M19 11C20.1046 11 21 11.8954 21 13V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V13C3 11.8954 3.89543 11 5 11M19 11V9C19 7.89543 18.1046 7 17 7M5 11V9C5 7.89543 5.89543 7 7 7M7 7V5C7 3.89543 7.89543 3 9 3H15C16.1046 3 17 3.89543 17 5V7M7 7H17" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path>
                            </g>
                        </svg>
                        <span class="tab tab-kategori block text-xs">Minha Conta</span>
                    </a>
                    <a href="#" class="w-full focus:text-blue-600 hover:text-blue-600 justify-center inline-block text-center pt-2 pb-1">
                        <svg width="25" height="25" viewBox="0 0 42 42" class="inline-block mb-1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="tab tab-explore block text-xs">Serviços</span>
                    </a>
                    <a href="#" class="w-full focus:text-blue-600 hover:text-blue-600 justify-center inline-block text-center pt-2 pb-1">
                        <svg width="25" height="25" viewBox="0 0 42 42" class="inline-block mb-1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="tab tab-whishlist block text-xs">Ajuda</span>
                    </a>
                </div>
            </section>
        </section>
