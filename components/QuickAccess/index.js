...
const MockData = [
    ...
    {icon:'', title: 'Conta Por Email', desc:'Deseja receber sua fatura por e-mail?'},
    {icon:'', title: 'Alteração de Titular', desc:'Deseja receber sua fatura por e-mail?'},
]
    ...
    <div className="p-4 w-full md:w-1/3">
        <div className="p-16 transition-all duration-150 bg-white rounded-lg shadow-xl ease hover:shadow-2xl">
            <div
                ...
                <svg className="relative w-12 h-12 text-blue-500" fill="none" stroke="currentColor"
            ...
            <div className="mt-3 mb-6">
                <h5 className="pb-2 text-xl font-bold leading-6 text-gray-600">{title}</h5>
