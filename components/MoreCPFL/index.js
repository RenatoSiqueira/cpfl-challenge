...
const MockData = [
    {img: 'item-cafefilosofico.jpg', title:'Instituto CPFL', desc: 'Conheça todos as ações do Grupo CPFL'},
    {img: 'guardiao-da-vida.jpg', title:'Guardião da Vida', desc:'Evite os Riscos: A informação é a melhor Proteção'},
    {img: 'ourpeople.png', title:'Nossa Gente', desc:'Conheça nossos programas de valorização da diversidade e desenvolvimento da ética.'},
    {img: 'relatorios.jpg', title:'Relatório Anual', desc:'A CPFL Energia apresenta suas principais informações econômicas, sociais e ambientais.'},
    {img: 'fornecedores.jpg', title:'Fornecedores', desc:'Portal para fornecedores do Grupo CPFL Energia'},
    {img: 'sac-4.0.jpg', title:'Atendimento', desc:'Confira os canais de atendimento da CPFL Energia'}
]
...
const MoreCPFL = () => (
    ...
    <div className="container flex flex-col items-center justify-center px-4 pt-2 pb-8 mx-auto sm:px-6 lg:px-8">
        <h2
            ...
            Conheça a <span className="inline-block text-blue-500">CPFL</span></h2>
