  ...
  <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-11 gap-10 lg:gap-20 mb-3">
    <div class="col-span-3">
      ...
      <p class="text-xs my-4 text-gray-700">
        Hosted in the EU 🇪🇺, with <strong>no user tracking</strong> scripts. Made all over the world by <a href="#" class="underline" target="_blank">17 amazing people</a>.
      </p>
    </div>
    <nav class="col-span-1 md:col-span-1 lg:col-span-2">
      <p class="uppercase text-gray-600 text-xs tracking-wider font-semibold mb-3">Product</p>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#">Features</a>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#">Pricing</a>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#">Feedback</a>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#">FAQs</a>
    </nav>
    <nav class="col-span-2 md:col-span-1 lg:col-span-2">
      <p class="uppercase text-gray-600 text-xs tracking-wider font-semibold mb-3">Support</p>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#">Chat</a>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#"> Email Support </a>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#">GDPR</a>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#"> Help </a>
    </nav>
    <nav class="col-span-1 md:col-span-1 lg:col-span-2">
      <p class="uppercase text-gray-600 text-xs tracking-wider font-semibold mb-3">Resources</p>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#">Blog</a>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#"> Twitter </a>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#">Alternatives</a>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#">Why feature vote?</a>
    </nav>
    <nav class="col-span-1 md:col-span-1 lg:col-span-2">
      <p class="uppercase text-gray-600 text-xs tracking-wider font-semibold mb-3">Company</p>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#">About Us</a>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#">Privacy</a>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#">Terms</a>
      <a class="flex mb-3 md:mb-2 text-sm font-medium text-gray-800 hover:text-purple-800 transition-colors duration-100 ease-in" href="#">Status</a>
    </nav>
  </div>
  <div class="flex flex-col md:flex-row justify-between items-start md:items-center border-t border-gray-200 pt-10 mt-10">
    <p class="text-gray-700 font-medium text-xs text-left mb-2 md:mb-0">Built by Product Managers, for Product Managers.</p>
